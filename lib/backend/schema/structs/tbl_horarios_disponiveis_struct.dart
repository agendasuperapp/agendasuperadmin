...
class TblHorariosDisponiveisStruct extends BaseStruct {
  ...
  static TblHorariosDisponiveisStruct fromMap(Map<String, dynamic> data) =>
      TblHorariosDisponiveisStruct(
  ...
  static TblHorariosDisponiveisStruct? maybeFromMap(dynamic data) => data is Map
      ? TblHorariosDisponiveisStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static TblHorariosDisponiveisStruct fromSerializableMap(
  ...
  @override
  String toString() => 'TblHorariosDisponiveisStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is TblHorariosDisponiveisStruct &&
...
TblHorariosDisponiveisStruct createTblHorariosDisponiveisStruct({
  int? idEstabelecimento,
  int? idProfissional,
  String? diaSemana,
  String? hora,
