...
class TblAfiliadosCuponsPadTable
    extends SupabaseTable<TblAfiliadosCuponsPadRow> {
  @override
  String get tableName => 'tbl_afiliados_cupons_pad';

  @override
  TblAfiliadosCuponsPadRow createRow(Map<String, dynamic> data) =>
      TblAfiliadosCuponsPadRow(data);
}

class TblAfiliadosCuponsPadRow extends SupabaseDataRow {
  TblAfiliadosCuponsPadRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TblAfiliadosCuponsPadTable();
