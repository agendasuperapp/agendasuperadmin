...
class TblEstabelecimentoTable extends SupabaseTable<TblEstabelecimentoRow> {
  @override
  String get tableName => 'tbl_estabelecimento';

  @override
  TblEstabelecimentoRow createRow(Map<String, dynamic> data) =>
      TblEstabelecimentoRow(data);
}

class TblEstabelecimentoRow extends SupabaseDataRow {
  TblEstabelecimentoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TblEstabelecimentoTable();
