...
class ViewInternalTblPagamentosStripeAppsPveabxaTable
    extends SupabaseTable<ViewInternalTblPagamentosStripeAppsPveabxaRow> {
  @override
  String get tableName => 'view_internal_tbl_pagamentos_stripe_apps_pveabxa';

  @override
  ViewInternalTblPagamentosStripeAppsPveabxaRow createRow(
          Map<String, dynamic> data) =>
      ViewInternalTblPagamentosStripeAppsPveabxaRow(data);
}

class ViewInternalTblPagamentosStripeAppsPveabxaRow extends SupabaseDataRow {
  ViewInternalTblPagamentosStripeAppsPveabxaRow(Map<String, dynamic> data)
      : super(data);

  @override
  SupabaseTable get table => ViewInternalTblPagamentosStripeAppsPveabxaTable();
