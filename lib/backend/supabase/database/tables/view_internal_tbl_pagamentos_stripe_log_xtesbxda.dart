...
class ViewInternalTblPagamentosStripeLogXtesbxdaTable
    extends SupabaseTable<ViewInternalTblPagamentosStripeLogXtesbxdaRow> {
  @override
  String get tableName => 'view_internal_tbl_pagamentos_stripe_log_xtesbxda';

  @override
  ViewInternalTblPagamentosStripeLogXtesbxdaRow createRow(
          Map<String, dynamic> data) =>
      ViewInternalTblPagamentosStripeLogXtesbxdaRow(data);
}

class ViewInternalTblPagamentosStripeLogXtesbxdaRow extends SupabaseDataRow {
  ViewInternalTblPagamentosStripeLogXtesbxdaRow(Map<String, dynamic> data)
      : super(data);

  @override
  SupabaseTable get table => ViewInternalTblPagamentosStripeLogXtesbxdaTable();
