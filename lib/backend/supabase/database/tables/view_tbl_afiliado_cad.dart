...
class ViewTblAfiliadoCadTable extends SupabaseTable<ViewTblAfiliadoCadRow> {
  @override
  String get tableName => 'view_tbl_afiliado_cad';

  @override
  ViewTblAfiliadoCadRow createRow(Map<String, dynamic> data) =>
      ViewTblAfiliadoCadRow(data);
}

class ViewTblAfiliadoCadRow extends SupabaseDataRow {
  ViewTblAfiliadoCadRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewTblAfiliadoCadTable();
  ...
  DateTime? get dataSaque => getField<DateTime>('data_saque');
  set dataSaque(DateTime? value) => setField<DateTime>('data_saque', value);

  String? get diaSaque => getField<String>('dia_saque');
  set diaSaque(String? value) => setField<String>('dia_saque', value);

  String? get nomeFormatado => getField<String>('nome_formatado');
  set nomeFormatado(String? value) => setField<String>('nome_formatado', value);
}
