...
class ViewTblAfiliadoPlanoPgTable
    extends SupabaseTable<ViewTblAfiliadoPlanoPgRow> {
  @override
  String get tableName => 'view_tbl_afiliado_plano_pg';

  @override
  ViewTblAfiliadoPlanoPgRow createRow(Map<String, dynamic> data) =>
      ViewTblAfiliadoPlanoPgRow(data);
}

class ViewTblAfiliadoPlanoPgRow extends SupabaseDataRow {
  ViewTblAfiliadoPlanoPgRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewTblAfiliadoPlanoPgTable();
