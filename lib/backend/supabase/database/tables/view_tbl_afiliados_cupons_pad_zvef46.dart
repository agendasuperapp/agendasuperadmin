...
class ViewTblAfiliadosCuponsPadZvef46Table
    extends SupabaseTable<ViewTblAfiliadosCuponsPadZvef46Row> {
  @override
  String get tableName => 'view_tbl_afiliados_cupons_pad_zvef46';

  @override
  ViewTblAfiliadosCuponsPadZvef46Row createRow(Map<String, dynamic> data) =>
      ViewTblAfiliadosCuponsPadZvef46Row(data);
}

class ViewTblAfiliadosCuponsPadZvef46Row extends SupabaseDataRow {
  ViewTblAfiliadosCuponsPadZvef46Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewTblAfiliadosCuponsPadZvef46Table();
