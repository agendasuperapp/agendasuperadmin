...
class ViewTblNotificacoesTable extends SupabaseTable<ViewTblNotificacoesRow> {
  @override
  String get tableName => 'view_tbl_notificacoes';

  @override
  ViewTblNotificacoesRow createRow(Map<String, dynamic> data) =>
      ViewTblNotificacoesRow(data);
}

class ViewTblNotificacoesRow extends SupabaseDataRow {
  ViewTblNotificacoesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewTblNotificacoesTable();
