...
class ZDeleteTblEstabelecimentoPlanoTable
    extends SupabaseTable<ZDeleteTblEstabelecimentoPlanoRow> {
  @override
  String get tableName => 'z_delete_tbl_estabelecimento_plano';

  @override
  ZDeleteTblEstabelecimentoPlanoRow createRow(Map<String, dynamic> data) =>
      ZDeleteTblEstabelecimentoPlanoRow(data);
}

class ZDeleteTblEstabelecimentoPlanoRow extends SupabaseDataRow {
  ZDeleteTblEstabelecimentoPlanoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ZDeleteTblEstabelecimentoPlanoTable();
