...
import 'dashb25_model.dart';
export 'dashb25_model.dart';

class Dashb25Widget extends StatefulWidget {
  const Dashb25Widget({super.key});

  static String routeName = 'dashb25';
  static String routePath = '/dashb25';

  @override
  State<Dashb25Widget> createState() => _Dashb25WidgetState();
}

class _Dashb25WidgetState extends State<Dashb25Widget>
    with TickerProviderStateMixin {
  late Dashb25Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Dashb25Model());
