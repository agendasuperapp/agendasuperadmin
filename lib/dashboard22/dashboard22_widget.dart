...
import 'dashboard22_model.dart';
export 'dashboard22_model.dart';

class Dashboard22Widget extends StatefulWidget {
  const Dashboard22Widget({super.key});

  static String routeName = 'dashboard22';
  static String routePath = '/dashboard22';

  @override
  State<Dashboard22Widget> createState() => _Dashboard22WidgetState();
}

class _Dashboard22WidgetState extends State<Dashboard22Widget>
    with TickerProviderStateMixin {
  late Dashboard22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Dashboard22Model());
