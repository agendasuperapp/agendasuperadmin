...
abstract class FlutterFlowTheme {
  ...
  late Color customTextoMenuLateral;
  late Color customTextoMenuLateralSelecionado;
  late Color customMenuLateralSelecionado;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color customTextoMenuLateral = Color(0xFFE0E3E7);
  late Color customTextoMenuLateralSelecionado = Color(0xFF4B39EF);
  late Color customMenuLateralSelecionado = Color(0xFFFFFFFF);
  late Color cCFundoContainesDados = Color(0x26E0E3E7);
  late Color customBordaInativos = Color(0xFFF1BCA5);
  late Color customBordaAtivos = Color(0xFF8AF3E9);
  late Color customFundoShowComponentes = Color(0x80000000);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color customTextoMenuLateral = Color(0xFF95A1AC);
  late Color customTextoMenuLateralSelecionado = Color(0xFF5DE9EF);
  late Color customMenuLateralSelecionado = Color(0xFF262D34);
  late Color cCFundoContainesDados = Color(0x1A262D34);
  late Color customBordaInativos = Color(0xFFF1BCA5);
  late Color customBordaAtivos = Color(0xFF8AF3E9);
  late Color customFundoShowComponentes = Color(0x80000000);
}
