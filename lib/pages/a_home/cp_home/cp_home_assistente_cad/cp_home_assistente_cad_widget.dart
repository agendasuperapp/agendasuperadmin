...
import '/pages/b_estabelecimento/comp_estabelecimento/cp_cad_servicos/cp_cad_servicos_widget.dart';
import '/pages/b_estabelecimento/comp_estabelecimento/cp_estabelec_cad_hr_atendimentos/cp_estabelec_cad_hr_atendimentos_widget.dart';
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            keyboardType:
                                                                                TextInputType.name,
                                                                            validator:
                                                                                _model.textFieldComplementoTextControllerValidator.asValidator(context),
                                                                            inputFormatters: [
                                                                              if (!isAndroid && !isiOS)
                                                                                TextInputFormatter.withFunction((oldValue, newValue) {
                                                                                  return TextEditingValue(
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (selectedMedia !=
                                                                          ...
                                                                          safeSetState(() =>
                                                                              _model.isDataUploading_uploadDataProfissionaisAss = true);
                                                                          var selectedUploadedFiles =
                                                                              <FFUploadedFile>[];
