...
class _CpLoginWidgetState extends State<CpLoginWidget>
  ...
  void initState() {
    ...
    _model.textFieldEntrarEmailTextController ??= TextEditingController(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFF262D34), Color(0xFF11423E)],
            stops: [0.0, 1.0],
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                FFAppState().varContadorInicializacoesDesenv =
                                    FFAppState()
                                            .varContadorInicializacoesDesenv +
                                        1;
                                safeSetState(() {});
                                if (FFAppState()
                                        .varContadorInicializacoesDesenv >
                                  ...
                                  safeSetState(() {
                                    _model.textFieldEntrarEmailTextController
                                        ?.text = 'hersoares12@gmail.com';
                                    _model.textFieldEntrarEmailFocusNode
                                        ?.requestFocus();
                                  ...
                                  valueOrDefault<String>(
                                    () {
                                      if (FFAppState().varIDAPPAfiliado == 1) {
                                        return 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/agenda-super-admin-0zp7nv/assets/nejangqxbbro/AgSuperBranco.png';
                                      } else if (FFAppState()
                                              .varIDAPPAfiliado ==
                                          3) {
                                ...
                                onPressed: () async {
                                  ...
                                  if (_model.acVerificarCamposEntrar2!) {
                                    ...
                                    final user =
                                      ...
                                      _model.textFieldEntrarEmailTextController
                                          .text,
                                      _model.textFieldEntrarSenhaTextController
                                          .text,
                                    );
                                    if (user == null) {
                                      return;
                                            ...
                                            builder: (context) => Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                highlightColor:
                                                    Colors.transparent,
                                                onTap: () async {
                                                  if (_model.uploadedFileUrl_uploadDataClientesCad !=
                                                          '') {
                                                    await showDialog(
                                                      barrierColor:
                                                          Color(0xD714181B),
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                _model.varUrlFotoExcluir = _model
                                                    .uploadedFileUrl_uploadDataClientesCad;
                                                safeSetState(() {});
                                                final selectedMedia =
                                                    await selectMedia(
                                                ...
                                                if (selectedMedia != null &&
                                                    selectedMedia.every((m) =>
                                                        validateFileFormat(
                                                            ...
                                                            context))) {
                                                  safeSetState(() => _model
                                                          .isDataUploading_uploadDataClientesCad =
                                                      true);
                                                  ...
                                                  try {
                                                    ...
                                                    _model.isDataUploading_uploadDataClientesCad =
                                                        false;
                                                  }
                                                  if (selectedUploadedFiles
                                                      ...
                                                      downloadUrls.length ==
                                                          selectedMedia
                                                              .length) {
                                                    safeSetState(() {
                                                      _model.uploadedLocalFile_uploadDataClientesCad =
                                                          selectedUploadedFiles
                                                              .first;
                                                      _model.uploadedFileUrl_uploadDataClientesCad =
                                                          downloadUrls.first;
                                                    });
                                                  } else {
                                                    safeSetState(() {});
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.varAutenticarComTelefone) {
                                        ...
                                        if (_model.queryConsTelCliRec?.length ==
                                            0) {
                                          await showDialog(
                                            context: context,
                                            builder: (alertDialogContext) {
                                        ...
                                        _model.apiResulEmailRecuperacao =
                                            await BrevoGroup.enivarEmailCall
                                                .call(
                                          emailSender: FFAppState()
                                              .VarEmailContatoAgendaSuper,
                                        ...
                                        if ((_model.apiResulEmailRecuperacao
                                          ...
                                          _model.varCodRecuperarSenhaEnviado =
                                              true;
                                          _model.varIDClienteRecuperarSenha =
                                              _model.queryConsEmailCliRec
                                                  ?.firstOrNull?.id;
                                          safeSetState(() {});
                                        }
                            ...
                            onTap: () async {
                              if (FFAppState().varIDAPPAfiliado == 1) {
                                await actions.caWebRedirectToUrl(
                                  'https://agendasuper.com.br/',
                                );
                              } else {
                                await actions.caWebRedirectToUrl(
                                  'https://rendarecorrente.app/',
                                );
                              }
                            },
                            child: Row(
