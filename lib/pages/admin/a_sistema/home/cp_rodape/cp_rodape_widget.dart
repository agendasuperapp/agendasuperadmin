              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(
                    valueOrDefault<double>(
                      FFAppState().VarTblDispositivoInformacoes.osName == 'iOS'
                          ? 12.0
                          : 0.0,
                      0.0,
                    ),
                ...
                child: Row(
                  ...
                  children: [
                          ...
                          child: Container(
                            ...
                            child: Align(
                              ...
                              child: MouseRegion(
                                ...
                                onExit: ((event) async {
                                  safeSetState(() =>
                                      _model.mouseRegionComissaoDiariaHovered =
                                          false);
                                }),
                              ),
                            ),
                    ...
                    MouseRegion(
                      ...
                      onEnter: ((event) async {
                        safeSetState(
                            () => _model.mouseRegionMenuHovered = true);
                      }),
                      onExit: ((event) async {
                        safeSetState(
                            () => _model.mouseRegionMenuHovered = false);
                      }),
                    ),
                    Expanded(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Align(
                            ...
                            child: MouseRegion(
                              ...
                              onEnter: ((event) async {
                                safeSetState(() => _model
                                    .mouseRegionNotificacoesHovered = true);
                              }),
                              onExit: ((event) async {
                                safeSetState(() => _model
