                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<
                            ...
                            future: (_model.requestCompleter ??= Completer<
                                    List<ViewTblAfiliadosCuponsAdminRow>>()
                                  ..complete(ViewTblAfiliadosCuponsAdminTable()
                                      .queryRows(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ViewTblAfiliadosCuponsAdminRow>
                                  listViewViewTblAfiliadosCuponsAdminRowList =
                                  snapshot.data!;

                              if (listViewViewTblAfiliadosCuponsAdminRowList
                                  .isEmpty) {
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  final listViewViewTblAfiliadosCuponsAdminRow =
                                      listViewViewTblAfiliadosCuponsAdminRowList[
                                          listViewIndex];
                                  return Container(
                                    width: 100.0,
                                    decoration: BoxDecoration(
                                      color:
                                          listViewViewTblAfiliadosCuponsAdminRow
                                                  .situacao!
                                              ? FlutterFlowTheme.of(context)
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: FlutterFlowTheme
                                                            ...
                                                            .override(
                                                              ...
                                                              color: listViewViewTblAfiliadosCuponsAdminRow.situacao!
                                                                  ? FlutterFlowTheme.of(
                                                                          context)
                                                                      .secondaryText
                                                                  : FlutterFlowTheme.of(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            '${MediaQuery.sizeOf(context).width < kBreakpointSmall ? 'TIPO: ' : 'TIPO DE CUPOM: '} ${listViewViewTblAfiliadosCuponsAdminRow.tipoCupom == 'DESCONTO' ? 'DESCONTO ${listViewViewTblAfiliadosCuponsAdminRow.percDesconto?.toString()}%' : '${listViewViewTblAfiliadosCuponsAdminRow.tempo?.toString()}${listViewViewTblAfiliadosCuponsAdminRow.tipoCupom == 'MES' ? (listViewViewTblAfiliadosCuponsAdminRow.tempo == 1 ? ' MES' : ' MESES') : (listViewViewTblAfiliadosCuponsAdminRow.tempo == 1 ? ' DIA' : ' DIAS')}'}',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'QUANT. USADOS: ${listViewViewTblAfiliadosCuponsAdminRow.quantUsado?.toString()}',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                                    ...
                                                    if (responsiveVisibility(
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          Icon(
                                                            Icons.sell_outlined,
                                                            color: listViewViewTblAfiliadosCuponsAdminRow
                                                                    .cupomPadrao!
                                                                ? FlutterFlowTheme.of(
                                                                        context)
                                                                    .success
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'CUPOM PADRÃO: ${listViewViewTblAfiliadosCuponsAdminRow.cupomPadrao! ? 'SIM' : 'NÃO'}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                                  .override(
                                                                    ...
                                                                    color: listViewViewTblAfiliadosCuponsAdminRow.cupomPadrao!
                                                                        ? FlutterFlowTheme.of(context)
                                                                            .success
                                                                        : FlutterFlowTheme.of(context)
                                                                            .error,
