...
import 'cp_lista_eventos_stripe_model.dart';
export 'cp_lista_eventos_stripe_model.dart';

class CpListaEventosStripeWidget extends StatefulWidget {
  const CpListaEventosStripeWidget({
    super.key,
    bool? paramAbrirCustomDialog,
    int? paramIDEstabelecimento,
    required this.paramContaProducao,
  })  : this.paramAbrirCustomDialog = paramAbrirCustomDialog ?? false,
        this.paramIDEstabelecimento = paramIDEstabelecimento ?? 0;

  final bool paramAbrirCustomDialog;
  final int paramIDEstabelecimento;
  final bool? paramContaProducao;

  @override
  State<CpListaEventosStripeWidget> createState() =>
      _CpListaEventosStripeWidgetState();
}

class _CpListaEventosStripeWidgetState
    extends State<CpListaEventosStripeWidget> {
  late CpListaEventosStripeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpListaEventosStripeModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.queryTblEstabelecimentosFiltro =
          await ViewTblEstabelecimentosFiltroTable().queryRows(
        queryFn: (q) => q,
      );
      _model.queryNomesEventos =
          await ViewTblPagamentosStripeEventosTable().queryRows(
        queryFn: (q) => q,
      );
      _model.queryStatusAssinatura =
          await ViewTblPgStStatusAssinaturaFiltroTable().queryRows(
        queryFn: (q) => q,
      );
      _model.varTblEstabelecimentos = _model.queryTblEstabelecimentosFiltro!
          .toList()
          .cast<ViewTblEstabelecimentosFiltroRow>();
      _model.varTblEventos = _model.queryNomesEventos!
          .toList()
          .cast<ViewTblPagamentosStripeEventosRow>();
      _model.varTblStatusAssinatura = _model.queryStatusAssinatura!
          .toList()
          .cast<ViewTblPgStStatusAssinaturaFiltroRow>();
      safeSetState(() {});
      await _model.acAtualizarDadosAPI(
        context,
        paramNavPrimeiraPag: false,
        paramAbrirTelaAguarde: true,
      );
    });
    ...
    _model.switchContaProducaoValue = widget.paramContaProducao!;
        ...
        child: Padding(
          ...
          child: Container(
            ...
            constraints: BoxConstraints(
              maxWidth: widget.paramAbrirCustomDialog
                  ? 2500.0
                  : MediaQuery.sizeOf(context).width,
              maxHeight: widget.paramAbrirCustomDialog
                  ? 1800.0
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(valueOrDefault<double>(
                widget.paramAbrirCustomDialog ? 15.0 : 0.0,
                0.0,
              )),
            ),
            child: Stack(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (widget.paramAbrirCustomDialog)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 12.0, 0.0),
                                      child: InkWell(
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText:
                                              'Pesquisar E-mail, ID Subscrição ou ID Stripe...',
                                    ...
                                    FlutterFlowDropDown<int>(
                                      controller: _model
                                              .dropDownEstabelecimentosValueController ??=
                                          FormFieldController<int>(
                                        _model.dropDownEstabelecimentosValue ??=
                                            (widget.paramIDEstabelecimento !=
                                                        null) &&
                                                    (widget.paramIDEstabelecimento >
                                                        0)
                                                ? widget.paramIDEstabelecimento
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller: _model
                                              .dropDownEventosValueController ??=
                                          FormFieldController<String>(
                                        _model.dropDownEventosValue ??= (widget
                                      ...
                                      options: List<String>.from(_model
                                          ...
                                          .withoutNulls
                                          .toList()),
                                      optionLabels: _model.varTblEventos
                                          .map((e) => e.nomeEvento)
                                          .withoutNulls
                                          .toList(),
                                      onChanged: (val) async {
                                        safeSetState(() =>
                                            _model.dropDownEventosValue = val);
                                        await _model.acAtualizarDadosAPI(
                                          context,
                                          paramNavPrimeiraPag: true,
                                          paramAbrirTelaAguarde: true,
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller:
                                          _model.dropDownErroValueController ??=
                                              FormFieldController<String>(
                                        _model.dropDownErroValue ??= 'todos',
                                      ),
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller: _model
                                              .dropDownCancelamentosValueController ??=
                                          FormFieldController<String>(
                                        _model.dropDownCancelamentosValue ??=
                                            'todos',
                                      ),
                                      options: List<String>.from(
                                          ['todos', 'solicitou']),
                                      ...
                                      onChanged: (val) async {
                                        safeSetState(() => _model
                                            .dropDownCancelamentosValue = val);
                                        await _model.acAtualizarDadosAPI(
                                          context,
                                          paramNavPrimeiraPag: true,
                                          paramAbrirTelaAguarde: true,
                              ...
                              child: Builder(
                                builder: (context) {
                                  final varResultApiviewTblEstabelecimentosAdmin =
                                      getJsonField(
                                    _model.varTblPagamentosStripeLogJson,
                                    r'''$''',
                                  ).toList();
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Status Pag: ${valueOrDefault<String>(
                                                        getJsonField(
                                                          varResultApiviewTblEstabelecimentosAdminItem,
                                                          r'''$.payment_status''',
                                                        )?.toString(),
