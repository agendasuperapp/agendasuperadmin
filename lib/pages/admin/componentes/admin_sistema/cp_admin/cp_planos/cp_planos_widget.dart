...
import 'cp_planos_model.dart';
export 'cp_planos_model.dart';

class CpPlanosWidget extends StatefulWidget {
  const CpPlanosWidget({
    super.key,
    bool? paramAdmin,
  ...
  @override
  State<CpPlanosWidget> createState() => _CpPlanosWidgetState();
}

class _CpPlanosWidgetState extends State<CpPlanosWidget>
    with TickerProviderStateMixin {
  late CpPlanosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpPlanosModel());
                                ...
                                onTap: () async {
                                  ...
                                  if (_model.tabBarPreviousIndex == 0) {
                                    safeSetState(
                                        () => _model.requestCompleter2 = null);
                                    await _model.waitForRequestCompleted2();
                                  } else if (_model.tabBarPreviousIndex == 1) {
                                    safeSetState(
                                        () => _model.requestCompleter1 = null);
                                    await _model.waitForRequestCompleted1();
                                  } else if (_model.tabBarPreviousIndex == 2) {
                                    safeSetState(
                                        () => _model.requestCompleter4 = null);
                                    await _model.waitForRequestCompleted4();
                                  } else if (_model.tabBarPreviousIndex == 3) {
                                    safeSetState(
                              ...
                              children: [
                                                                                  ...
                                                                                  return WebViewAware(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: CpCadPlanosPrecosWidget(
                                                                                        paramCadastro: false,
                                                                                        paramRowTblPlanoPreco: columnPlanosPrecosViewTblAppPlanosRow,
                                                                                      ),
                                                                                    ),
                                                                                  );
                                                                                },
                                ...
                                Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        FutureBuilder<List<TblPlanosNomesRow>>(
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<List<TblPlanosNomesRow>>(
                                    future: (_model.requestCompleter4 ??=
                                            Completer<List<TblPlanosNomesRow>>()
                                              ..complete(TblPlanosNomesTable()
                                                  .queryRows(
                                                queryFn: (q) => q
                                                    .eqOrNull(
                                                      'situacao',
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<TblPlanosNomesRow>
                                          columnPlanosNomesTblPlanosNomesRowList =
                                          snapshot.data!;

                                      if (columnPlanosNomesTblPlanosNomesRowList
                                          .isEmpty) {
                                        return CpSemCadastroWidget();
                                      }
                                      ...
                                      return Column(
                                        ...
                                        children: List.generate(
                                          ...
                                          final columnPlanosNomesTblPlanosNomesRow =
                                              columnPlanosNomesTblPlanosNomesRowList[
                                                  columnPlanosNomesIndex];
                                          return Align(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color:
                                                    columnPlanosNomesTblPlanosNomesRow
                                                            .situacao!
                                                        ? FlutterFlowTheme.of(
                                                                context)
                                                            .cCFundoContainesDados
                                                ...
                                                border: Border.all(
                                                  color:
                                                      columnPlanosNomesTblPlanosNomesRow.situacao!
                                                          ? FlutterFlowTheme.of(
                                                                  context)
                                                              .alternate
                                                          : FlutterFlowTheme.of(
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        columnPlanosNomesTblPlanosNomesRow.qtAgendamentosMax ==
                                                                                1
                                                                            ? '1 Profissional'
                                                                            : '${columnPlanosNomesTblPlanosNomesRow.qtProfissionaisMin?.toString()} a ${columnPlanosNomesTblPlanosNomesRow.qtProfissionaisMax?.toString()} Profissionais',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              font: GoogleFonts.readexPro(
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Limite de agendamentos:  ${columnPlanosNomesTblPlanosNomesRow.qtAgendamentosMax?.toString()}',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              font: GoogleFonts.readexPro(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            mainAxisAlignment:
                                                                MainAxisAlignment
                                                                    .center,
                                                            children: [
                                                              if (columnPlanosNomesTblPlanosNomesRow
                                                                      .situacao ??
                                                                  true)
                                                                Padding(
                                                                      ...
                                                                      var confirmDialogResponse = await showDialog<
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return WebViewAware(
                                                                                child: AlertDialog(
                                                                                  title: Text('Atenção!'),
                                                                                  content: Text('Deseja INATIVAR o nome ${columnPlanosNomesTblPlanosNomesRow.nome}? (Todos os planos que usam esse nome serão inativados)'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                                      onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                      child: Text('Não'),
                                                                      ...
                                                                      if (confirmDialogResponse) {
                                                                        await TblPlanosNomesTable()
                                                                          ...
                                                                          matchingRows: (rows) =>
                                                                              rows.eqOrNull(
                                                                            'id',
                                                                            columnPlanosNomesTblPlanosNomesRow.id,
                                                                          ),
                                                                        );
                                                                      ...
                                                                      var confirmDialogResponse = await showDialog<
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return WebViewAware(
                                                                                child: AlertDialog(
                                                                                  title: Text('Atenção!'),
                                                                                  content: Text('Deseja ATIVAR o nome ${columnPlanosNomesTblPlanosNomesRow.nome}? (Todos os planos que usam esse nome serão ativados)'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                                      onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                      child: Text('Não'),
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 4.0, 0.0, 0.0),
                                  child:
                                      FutureBuilder<List<TblPlanosPeriodosRow>>(
                                    future:
