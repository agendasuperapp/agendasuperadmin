...
import 'd_e_l_e_t_e_cp_lista_estabelecimentos_admin_model.dart';
export 'd_e_l_e_t_e_cp_lista_estabelecimentos_admin_model.dart';

class DELETECpListaEstabelecimentosAdminWidget extends StatefulWidget {
  const DELETECpListaEstabelecimentosAdminWidget({super.key});

  @override
  State<DELETECpListaEstabelecimentosAdminWidget> createState() =>
      _DELETECpListaEstabelecimentosAdminWidgetState();
}

class _DELETECpListaEstabelecimentosAdminWidgetState
    extends State<DELETECpListaEstabelecimentosAdminWidget>
    with TickerProviderStateMixin {
  late DELETECpListaEstabelecimentosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => DELETECpListaEstabelecimentosAdminModel());
    ...
    return Align(
      ...
      child: FutureBuilder<ApiCallResponse>(
        future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
              ..complete(SupabaseGroup.viewtblestabelecimentosadminCall.call(
                token: currentJwtToken,
                situacao: _model.switchSituacaoValue?.toString(),
                assinatura: _model.dropDownTipoValue == 'todos'
                    ? ''
                    : _model.dropDownTipoValue,
                contaTeste: _model.switchContaProducaoValue! ? 'false' : 'true',
                idPlanoNome: _model.dropDownNomesPlanosValue == 0
                    ? ''
                    : _model.dropDownNomesPlanosValue?.toString(),
                statusPlano: _model.dropDownStatusPlanoValue == 'todos'
                    ? ''
                    : _model.dropDownStatusPlanoValue,
                statusPagamento: _model.dropDownStatusPagamentoValue == 'todos'
                    ? ''
        ...
        builder: (context, snapshot) {
          ...
          final containerViewAPIViewtblestabelecimentosadminResponse =
              snapshot.data!;
                              ...
                              child: Builder(
                                builder: (context) {
                                  final varResultApiviewTblEstabelecimentosAdmin =
                                      getJsonField(
                                    containerViewAPIViewtblestabelecimentosadminResponse
                                        .jsonBody,
                                    r'''$''',
                                  ).toList();
                          ...
                          if (responsiveVisibility(
                            ...
                            FutureBuilder<
                              ...
                              future: (_model.requestCompleter ??= Completer<
                                      List<ViewTblEstabelecimentosAdminRow>>()
                                    ..complete(
                                        ViewTblEstabelecimentosAdminTable()
                                            .queryRows(
                                                              ...
                                                              children: [
                                                                Container(
                                                                  decoration:
                                                                      BoxDecoration(),
                                                                  child: Text(
                                                                    'Código: ${listViewCelularViewTblEstabelecimentosAdminRow.id}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              title: Text('Atenção!'),
                                                                              content: Text('Deseja Desbloquear/Ativar o estabelecimento ${listViewCelularViewTblEstabelecimentosAdminRow.nome}?'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                  child: Text('Não'),
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              title: Text('Atenção!'),
                                                                              content: Text('Deseja Bloquear/Inativar o estabelecimento ${listViewCelularViewTblEstabelecimentosAdminRow.nome}?'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                  child: Text('Não'),
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(4.0),
                        child: Text(
                          'Quant. Resultados: ${valueOrDefault<String>(
