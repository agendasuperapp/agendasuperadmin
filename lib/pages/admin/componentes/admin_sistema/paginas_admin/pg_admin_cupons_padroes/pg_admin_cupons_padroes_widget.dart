...
import '/pages/admin/componentes/admin_sistema/cp_admin/cp_admin_cupons_padroes/cp_admin_cupons_padroes_widget.dart';
import '/actions/actions.dart' as action_blocks;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:provider/provider.dart';
import 'pg_admin_cupons_padroes_model.dart';
export 'pg_admin_cupons_padroes_model.dart';

class PgAdminCuponsPadroesWidget extends StatefulWidget {
  const PgAdminCuponsPadroesWidget({super.key});

  static String routeName = 'pg_admin_cupons_padroes';
  static String routePath = '/admin/CuponsPadroes';

  @override
  State<PgAdminCuponsPadroesWidget> createState() =>
      _PgAdminCuponsPadroesWidgetState();
}

class _PgAdminCuponsPadroesWidgetState
    extends State<PgAdminCuponsPadroesWidget> {
  late PgAdminCuponsPadroesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAdminCuponsPadroesModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'CUPONS_PADROES',
