...
import 'pg_afiliados_admin_model.dart';
export 'pg_afiliados_admin_model.dart';

class PgAfiliadosAdminWidget extends StatefulWidget {
  const PgAfiliadosAdminWidget({super.key});

  static String routeName = 'pg_afiliados_admin';
  static String routePath = '/admin/AfiliadosAdmin';

  @override
  State<PgAfiliadosAdminWidget> createState() => _PgAfiliadosAdminWidgetState();
}

class _PgAfiliadosAdminWidgetState extends State<PgAfiliadosAdminWidget> {
  late PgAfiliadosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadosAdminModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'AFILIADOS',
