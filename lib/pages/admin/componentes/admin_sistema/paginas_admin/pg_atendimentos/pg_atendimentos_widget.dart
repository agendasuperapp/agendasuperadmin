...
import 'pg_atendimentos_model.dart';
export 'pg_atendimentos_model.dart';

class PgAtendimentosWidget extends StatefulWidget {
  const PgAtendimentosWidget({super.key});

  static String routeName = 'pg_atendimentos';
  static String routePath = '/admin/Atendimentos';

  @override
  State<PgAtendimentosWidget> createState() => _PgAtendimentosWidgetState();
}

class _PgAtendimentosWidgetState extends State<PgAtendimentosWidget> {
  late PgAtendimentosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAtendimentosModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'ATENDIMENTOS',
