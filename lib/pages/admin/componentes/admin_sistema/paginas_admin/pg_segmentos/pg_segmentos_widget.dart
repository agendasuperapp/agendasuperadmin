...
import 'pg_segmentos_model.dart';
export 'pg_segmentos_model.dart';

class PgSegmentosWidget extends StatefulWidget {
  const PgSegmentosWidget({super.key});

  static String routeName = 'pg_segmentos';
  static String routePath = '/admin/Segmentos';

  @override
  State<PgSegmentosWidget> createState() => _PgSegmentosWidgetState();
}

class _PgSegmentosWidgetState extends State<PgSegmentosWidget> {
  late PgSegmentosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgSegmentosModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'SEGMENTOS',
