...
import 'cp_afiliado_ativacao_model.dart';
export 'cp_afiliado_ativacao_model.dart';

class CpAfiliadoAtivacaoWidget extends StatefulWidget {
  const CpAfiliadoAtivacaoWidget({super.key});

  @override
  State<CpAfiliadoAtivacaoWidget> createState() =>
      _CpAfiliadoAtivacaoWidgetState();
}

class _CpAfiliadoAtivacaoWidgetState extends State<CpAfiliadoAtivacaoWidget> {
  late CpAfiliadoAtivacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpAfiliadoAtivacaoModel());
