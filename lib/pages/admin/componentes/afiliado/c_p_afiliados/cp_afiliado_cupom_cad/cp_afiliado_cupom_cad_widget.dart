...
import 'cp_afiliado_cupom_cad_model.dart';
export 'cp_afiliado_cupom_cad_model.dart';

class CpAfiliadoCupomCadWidget extends StatefulWidget {
  const CpAfiliadoCupomCadWidget({
    super.key,
  ...
  @override
  State<CpAfiliadoCupomCadWidget> createState() =>
      _CpAfiliadoCupomCadWidgetState();
}

class _CpAfiliadoCupomCadWidgetState extends State<CpAfiliadoCupomCadWidget> {
  late CpAfiliadoCupomCadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpAfiliadoCupomCadModel());
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return WebViewAware(
                                    child: AlertDialog(
                                      title: Text('Atenção!'),
                                      content: Text('Limite máximo de 30 dias'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
