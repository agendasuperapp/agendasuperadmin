...
import 'd_e_l_e_t_e_cp_afiliado_apresentacao_model.dart';
export 'd_e_l_e_t_e_cp_afiliado_apresentacao_model.dart';

class DELETECpAfiliadoApresentacaoWidget extends StatefulWidget {
  const DELETECpAfiliadoApresentacaoWidget({super.key});

  @override
  State<DELETECpAfiliadoApresentacaoWidget> createState() =>
      _DELETECpAfiliadoApresentacaoWidgetState();
}

class _DELETECpAfiliadoApresentacaoWidgetState
    extends State<DELETECpAfiliadoApresentacaoWidget> {
  late DELETECpAfiliadoApresentacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DELETECpAfiliadoApresentacaoModel());
