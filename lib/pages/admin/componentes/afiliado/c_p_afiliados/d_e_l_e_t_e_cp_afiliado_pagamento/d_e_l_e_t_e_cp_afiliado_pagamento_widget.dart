...
import 'd_e_l_e_t_e_cp_afiliado_pagamento_model.dart';
export 'd_e_l_e_t_e_cp_afiliado_pagamento_model.dart';

class DELETECpAfiliadoPagamentoWidget extends StatefulWidget {
  const DELETECpAfiliadoPagamentoWidget({
    super.key,
    required this.paramExternalReference,
    required this.paramRenovacao,
    this.paramTblViewTblAfiliadoPlano,
  });

  final String? paramExternalReference;
  final bool? paramRenovacao;
  final ViewTblAfiliadoPlanoRow? paramTblViewTblAfiliadoPlano;

  @override
  State<DELETECpAfiliadoPagamentoWidget> createState() =>
      _DELETECpAfiliadoPagamentoWidgetState();
}

class _DELETECpAfiliadoPagamentoWidgetState
    extends State<DELETECpAfiliadoPagamentoWidget>
    with TickerProviderStateMixin {
  late DELETECpAfiliadoPagamentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DELETECpAfiliadoPagamentoModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      safeSetState(() {
        _model.textFieldQrCodeCopiaColaTextController?.text = _model.varQrCode;
      });
    });
    ...
    _model.textFieldCardMesMask = MaskTextInputFormatter(mask: '##');
    _model.textFieldCardAnoTextController ??= TextEditingController();
    _model.textFieldCardAnoFocusNode ??= FocusNode();

    _model.textFieldCardAnoMask = MaskTextInputFormatter(mask: '####');
    _model.textFieldCardCVVTextController ??= TextEditingController();
    _model.textFieldCardCVVFocusNode ??= FocusNode();

    _model.textFieldCardCVVMask = MaskTextInputFormatter(mask: '###');
    _model.textFieldDocNumeroCPFTextController ??=
    ...
    _model.textFieldDocNumeroCPFMask =
        MaskTextInputFormatter(mask: '###.###.###-##');
    _model.textFieldDocNumeroCNPJTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.docCpfCnpj);
    _model.textFieldDocNumeroCNPJFocusNode ??= FocusNode();

    _model.textFieldDocNumeroCNPJMask =
        MaskTextInputFormatter(mask: '##.###.###.####-##');
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        widget.paramRenovacao!
                                            ? 'Renovação de afiliação'
                                            : 'Ativação de afiliação',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.readexPro(
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (_model.varPagoTeste) {
                                            _model.queryConsPag =
                                                await TblEstabPlanoMpTable()
                                                    .queryRows(
                                            ...
                                            if (_model.queryConsPag?.firstOrNull
                                                    ?.status ==
                                                'approved') {
                                              _model.varPgConfirmado = true;
                                              safeSetState(() {});
                                              if (_shouldSetState)
                                                safeSetState(() {});
                                              return;
                                          ...
                                          await TblEstabPlanoMpTable().insert({
                                            ...
                                            'net_received_amount': 39.90,
                                            'total_paid_amount': 39.90,
                                            ...
                                            'description':
                                                'Agenda Super - Ativação de Afiliação ',
                                            'id_estabelecimento': FFAppState()
                                                .VarIDEstabelecimentoLogado,
                                            'user_id': currentUserUid,
                                          });
                                          _model.resultInsertTblAfiliadoPlano =
                                              await TblAfiliadosPlanoTable()
                                                  .insert({
                                            'id_estabelecimento': FFAppState()
                                                .VarIDEstabelecimentoLogado,
                                            ...
                                            'data_final': supaSerialize<
                                                ...
                                                ? functions.fcAdicionarMesEmData(
                                                    ...
                                                    1)
                                                : functions
                                                    .fcAdicionarMesEmData(
                                                        getCurrentTimestamp,
                                                        1)),
                                            'situacao': true,
                                            'valor_sem_desconto': 39.90,
                                            'valor_com_desconto': 39.90,
                                            'status_pagamento': 'PAGO',
                                            'plano_ativo': true,
                                            'tempo': 1,
                                            'periodo_mes_dia': 'M',
                                            'user_id': currentUserUid,
                                            'renovacao': widget.paramRenovacao,
                                            'id_afiliado': FFAppState()
                                                .varIDAfiliadoLogado,
                                          ...
                                          await TblAfiliadosAtivDashTable()
                                            ...
                                            'situacao': true,
                                            'status_pag': 'PAGO',
                                            'id_afiliado_plano': _model
                                                .resultInsertTblAfiliadoPlano
                                                ?.id,
                                            'id_afiliado': FFAppState()
                                                .varIDAfiliadoLogado,
                                            'valor_pag': 39.90,
                                        ...
                                        text: 'Atualizar Pagamento (Teste)',
                                        icon: Icon(
                                          Icons.refresh_sharp,
                                          size: 15.0,
                                        ),
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Sua NF-e foi emitida e enviada \nno seu e-mail cadastrado',
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            containerTblEstabPlanoMpRow?.status,
                            '...',
                          ),
                          style:
