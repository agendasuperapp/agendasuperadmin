...
import 'd_e_l_e_t_e_cp_afiliado_plano_model.dart';
export 'd_e_l_e_t_e_cp_afiliado_plano_model.dart';

class DELETECpAfiliadoPlanoWidget extends StatefulWidget {
  const DELETECpAfiliadoPlanoWidget({super.key});

  @override
  State<DELETECpAfiliadoPlanoWidget> createState() =>
      _DELETECpAfiliadoPlanoWidgetState();
}

class _DELETECpAfiliadoPlanoWidgetState
    extends State<DELETECpAfiliadoPlanoWidget> with TickerProviderStateMixin {
  late DELETECpAfiliadoPlanoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DELETECpAfiliadoPlanoModel());
