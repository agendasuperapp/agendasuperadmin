...
import 'd_e_l_e_t_e_cp_afiliado_plano_renovar2_widget.dart'
    show DELETECpAfiliadoPlanoRenovar2Widget;
import 'package:flutter/material.dart';
import 'package:webviewx_plus/webviewx_plus.dart';

class DELETECpAfiliadoPlanoRenovar2Model
    extends FlutterFlowModel<DELETECpAfiliadoPlanoRenovar2Widget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in DELETE-cp_afiliado_plano_renovar2 widget.
  ...
  // Stores action output result for [Action Block - acCriarPagamentoAfiliacao] action in Button widget.
  String? acResultCriarPgPlanoAfilRenov;
  // Stores action output result for [Backend Call - Query Rows] action in Button widget.
  List<TblAfiliadosPlanoRow>? resultQueryPlanoAfilRenov;
