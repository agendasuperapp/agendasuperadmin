...
import 'd_e_l_e_t_e_pg_afiliado_apresentacao_model.dart';
export 'd_e_l_e_t_e_pg_afiliado_apresentacao_model.dart';

class DELETEPgAfiliadoApresentacaoWidget extends StatefulWidget {
  const DELETEPgAfiliadoApresentacaoWidget({super.key});

  static String routeName = 'DELETE_pg_afiliado_apresentacao';
  static String routePath = '/admin/AfiliadoApresentacao';

  @override
  State<DELETEPgAfiliadoApresentacaoWidget> createState() =>
      _DELETEPgAfiliadoApresentacaoWidgetState();
}

class _DELETEPgAfiliadoApresentacaoWidgetState
    extends State<DELETEPgAfiliadoApresentacaoWidget> {
  late DELETEPgAfiliadoApresentacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DELETEPgAfiliadoApresentacaoModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'AFILIADO_APRESENTACAO',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: wrapWithModel(
                          model: _model.dELETECpAfiliadoApresentacaoModel,
                          updateCallback: () => safeSetState(() {}),
                          child: DELETECpAfiliadoApresentacaoWidget(),
                        ),
                      ),
                    ),
                  ],
