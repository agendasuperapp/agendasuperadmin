...
import 'd_e_l_e_t_e_pg_afiliado_ativacao_model.dart';
export 'd_e_l_e_t_e_pg_afiliado_ativacao_model.dart';

class DELETEPgAfiliadoAtivacaoWidget extends StatefulWidget {
  const DELETEPgAfiliadoAtivacaoWidget({super.key});

  static String routeName = 'DELETE_pg_afiliado_ativacao';
  static String routePath = '/admin/AfiliadoAtivacao';

  @override
  State<DELETEPgAfiliadoAtivacaoWidget> createState() =>
      _DELETEPgAfiliadoAtivacaoWidgetState();
}

class _DELETEPgAfiliadoAtivacaoWidgetState
    extends State<DELETEPgAfiliadoAtivacaoWidget> {
  late DELETEPgAfiliadoAtivacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DELETEPgAfiliadoAtivacaoModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'AFILIADO_PG_PLANO',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: wrapWithModel(
                          model: _model.dELETECpAfiliadoAtivacaoModel,
                          updateCallback: () => safeSetState(() {}),
                          child: DELETECpAfiliadoAtivacaoWidget(),
                        ),
                      ),
                    ),
                  ],
