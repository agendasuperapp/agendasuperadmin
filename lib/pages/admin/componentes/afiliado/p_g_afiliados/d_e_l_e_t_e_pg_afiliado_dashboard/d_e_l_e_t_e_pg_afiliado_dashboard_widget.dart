...
import 'd_e_l_e_t_e_pg_afiliado_dashboard_model.dart';
export 'd_e_l_e_t_e_pg_afiliado_dashboard_model.dart';

class DELETEPgAfiliadoDashboardWidget extends StatefulWidget {
  const DELETEPgAfiliadoDashboardWidget({super.key});

  static String routeName = 'DELETE_pg_afiliado_dashboard';
  static String routePath = '/admin/AfiliadoDashboard';

  @override
  State<DELETEPgAfiliadoDashboardWidget> createState() =>
      _DELETEPgAfiliadoDashboardWidgetState();
}

class _DELETEPgAfiliadoDashboardWidgetState
    extends State<DELETEPgAfiliadoDashboardWidget> {
  late DELETEPgAfiliadoDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DELETEPgAfiliadoDashboardModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'AFILIADO_DASHBOARD',
