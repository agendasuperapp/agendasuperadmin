...
import 'pg_afiliado_apresentacao_model.dart';
export 'pg_afiliado_apresentacao_model.dart';

class PgAfiliadoApresentacaoWidget extends StatefulWidget {
  const PgAfiliadoApresentacaoWidget({super.key});

  static String routeName = 'pg_afiliado_apresentacao';
  static String routePath = '/admin/AfiliadoApresentacao';

  @override
  State<PgAfiliadoApresentacaoWidget> createState() =>
      _PgAfiliadoApresentacaoWidgetState();
}

class _PgAfiliadoApresentacaoWidgetState
    extends State<PgAfiliadoApresentacaoWidget> {
  late PgAfiliadoApresentacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoApresentacaoModel());
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: wrapWithModel(
                          model: _model.cpAfiliadoApesentacaoModel,
                          updateCallback: () => safeSetState(() {}),
                          child: CpAfiliadoApesentacaoWidget(),
                        ),
                      ),
                    ),
                  ],
