...
import 'pg_afiliado_ativacao_model.dart';
export 'pg_afiliado_ativacao_model.dart';

class PgAfiliadoAtivacaoWidget extends StatefulWidget {
  const PgAfiliadoAtivacaoWidget({super.key});

  static String routeName = 'pg_afiliado_ativacao';
  static String routePath = '/admin/AfiliadoAtivacao';

  @override
  State<PgAfiliadoAtivacaoWidget> createState() =>
      _PgAfiliadoAtivacaoWidgetState();
}

class _PgAfiliadoAtivacaoWidgetState extends State<PgAfiliadoAtivacaoWidget> {
  late PgAfiliadoAtivacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoAtivacaoModel());
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: wrapWithModel(
                          model: _model.cpAfiliadoAtivacaoModel,
                          updateCallback: () => safeSetState(() {}),
                          child: CpAfiliadoAtivacaoWidget(),
                        ),
                      ),
                    ),
                  ],
