...
import 'pg_afiliado_comissoes_mensais_model.dart';
export 'pg_afiliado_comissoes_mensais_model.dart';

class PgAfiliadoComissoesMensaisWidget extends StatefulWidget {
  const PgAfiliadoComissoesMensaisWidget({super.key});

  static String routeName = 'pg_afiliado_comissoes_mensais';
  static String routePath = '/admin/AfiliadoComissoesMensais';

  @override
  State<PgAfiliadoComissoesMensaisWidget> createState() =>
      _PgAfiliadoComissoesMensaisWidgetState();
}

class _PgAfiliadoComissoesMensaisWidgetState
    extends State<PgAfiliadoComissoesMensaisWidget> {
  late PgAfiliadoComissoesMensaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoComissoesMensaisModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'AFILIADO_COMISSOES_MENSAIS',
