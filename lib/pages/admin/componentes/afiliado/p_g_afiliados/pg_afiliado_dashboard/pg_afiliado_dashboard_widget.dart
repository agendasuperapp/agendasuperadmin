...
import 'pg_afiliado_dashboard_model.dart';
export 'pg_afiliado_dashboard_model.dart';

class PgAfiliadoDashboardWidget extends StatefulWidget {
  const PgAfiliadoDashboardWidget({super.key});

  static String routeName = 'pg_afiliado_dashboard';
  static String routePath = '/admin/AfiliadoDashboard';

  @override
  State<PgAfiliadoDashboardWidget> createState() =>
      _PgAfiliadoDashboardWidgetState();
}

class _PgAfiliadoDashboardWidgetState extends State<PgAfiliadoDashboardWidget> {
  late PgAfiliadoDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoDashboardModel());
