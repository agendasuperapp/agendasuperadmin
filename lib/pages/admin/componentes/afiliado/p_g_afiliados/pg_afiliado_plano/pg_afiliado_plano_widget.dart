...
import 'pg_afiliado_plano_model.dart';
export 'pg_afiliado_plano_model.dart';

class PgAfiliadoPlanoWidget extends StatefulWidget {
  const PgAfiliadoPlanoWidget({super.key});

  static String routeName = 'pg_afiliado_plano';
  static String routePath = '/admin/AfiliadoPlano';

  @override
  State<PgAfiliadoPlanoWidget> createState() => _PgAfiliadoPlanoWidgetState();
}

class _PgAfiliadoPlanoWidgetState extends State<PgAfiliadoPlanoWidget> {
  late PgAfiliadoPlanoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoPlanoModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'AFILIADO_PLANO',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: wrapWithModel(
                          model: _model.cpAfiliadoPlanoModel,
                          updateCallback: () => safeSetState(() {}),
                          child: CpAfiliadoPlanoWidget(),
                        ),
                      ),
                    ),
                  ],
