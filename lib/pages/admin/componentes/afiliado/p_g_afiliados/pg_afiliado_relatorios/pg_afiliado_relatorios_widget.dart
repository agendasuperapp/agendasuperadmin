...
import 'pg_afiliado_relatorios_model.dart';
export 'pg_afiliado_relatorios_model.dart';

class PgAfiliadoRelatoriosWidget extends StatefulWidget {
  const PgAfiliadoRelatoriosWidget({super.key});

  static String routeName = 'pg_afiliado_relatorios';
  static String routePath = '/admin/AfiliadoRelatorios';

  @override
  State<PgAfiliadoRelatoriosWidget> createState() =>
      _PgAfiliadoRelatoriosWidgetState();
}

class _PgAfiliadoRelatoriosWidgetState
    extends State<PgAfiliadoRelatoriosWidget> {
  late PgAfiliadoRelatoriosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoRelatoriosModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'AFILIADO_RELATORIOS',
