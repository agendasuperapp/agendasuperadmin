...
class CpCadProfissionaisModel
  ...
  final textFieldWhatsappMask = MaskTextInputFormatter(mask: '(##) #####-####');
  String? Function(BuildContext, String?)?
  ...
  ScrollController? columnHorariosPadroes;
  ...
  final textFieldHoraPadraoOp1Mask = MaskTextInputFormatter(mask: '##:##');
  String? Function(BuildContext, String?)?
  ...
  final textFieldHoraPadraoOp2Mask = MaskTextInputFormatter(mask: '##:##');
  String? Function(BuildContext, String?)?
  ...
  ScrollController? staggeredViewHrPadrao;
  // State field(s) for ListView widget.
  ScrollController? listViewController2;
  // State field(s) for ColumnHorariosFunc widget.
  ScrollController? columnHorariosFunc;
  ...
  final textFieldHoraDispMask = MaskTextInputFormatter(mask: '##:##');
  String? Function(BuildContext, String?)?
      textFieldHoraDispTextControllerValidator;
  // State field(s) for StaggeredViewHrLib widget.
  ScrollController? staggeredViewHrLib;

  @override
  void initState(BuildContext context) {
    columnPagina = ScrollController();
    staggeredViewServLib = ScrollController();
    listViewController1 = ScrollController();
    columnHorariosPadroes = ScrollController();
    staggeredViewHrPadrao = ScrollController();
    listViewController2 = ScrollController();
    columnHorariosFunc = ScrollController();
    ...
    staggeredViewHrLib = ScrollController();
  }

  @override
  void dispose() {
    columnPagina?.dispose();
    ...
    staggeredViewHrPadrao?.dispose();
    listViewController2?.dispose();
    columnHorariosFunc?.dispose();
