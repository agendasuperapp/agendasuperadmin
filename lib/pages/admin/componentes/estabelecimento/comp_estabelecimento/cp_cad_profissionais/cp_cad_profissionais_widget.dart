...
import '/pages/admin/componentes/estabelecimento/comp_estabelecimento/cp_configurar_hr_padrao/cp_configurar_hr_padrao_widget.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: SingleChildScrollView(
                controller: _model.columnPagina,
                child: Column(
                                ...
                                onTap: (i) async {
                                  [
                                    ...
                                    () async {
                                      ...
                                      if (_model.tabBarPreviousIndex == 2) {
                                        safeSetState(() =>
