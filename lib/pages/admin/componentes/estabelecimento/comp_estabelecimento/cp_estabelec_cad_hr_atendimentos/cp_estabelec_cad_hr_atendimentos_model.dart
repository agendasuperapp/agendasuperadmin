...
class CpEstabelecCadHrAtendimentosModel
  ...
  final textFieldHora1InicioMask = MaskTextInputFormatter(mask: '##:##');
  ...
  final textFieldHora1FimInicioIntervaloMask =
  ...
  final textFieldHora2InicioFimIntervaloMask =
      MaskTextInputFormatter(mask: '##:##');
  String? Function(BuildContext, String?)?
  ...
  final textFieldHora2FimMask = MaskTextInputFormatter(mask: '##:##');
  String? Function(BuildContext, String?)?
