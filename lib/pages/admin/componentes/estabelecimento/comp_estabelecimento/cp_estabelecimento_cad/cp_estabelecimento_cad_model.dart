...
class CpEstabelecimentoCadModel
  ...
  ScrollController? columnEmpresa;
  ...
  ScrollController? rowModelosBanners;
  ...
  ScrollController? rowFotosBanners;
  ...
  // Stores action output result for [Action Block - acSairSistema] action in Text widget.
  ...
  ScrollController? columnWhatsApp;
  ...
  final textFieldTelConexWhatsAppMask =
  ...
  void initState(BuildContext context) {
    columnEmpresa = ScrollController();
    rowModelosBanners = ScrollController();
    rowFotosBanners = ScrollController();
    ...
    columnWhatsApp = ScrollController();
