                  ...
                  children: [
                    ...
                    FutureBuilder<List<TblProfissionaisRow>>(
                      future: (_model.requestCompleter ??=
                              Completer<List<TblProfissionaisRow>>()
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<TblProfissionaisRow>
                            listViewTblProfissionaisRowList = snapshot.data!;
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            final listViewTblProfissionaisRow =
                                listViewTblProfissionaisRowList[listViewIndex];
                            return Container(
                              decoration: BoxDecoration(
                                        ...
                                        if (FFAppState()
                                          ...
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              ...
                                              'paramIDProfissional':
                                                  serializeParam(
                                                listViewTblProfissionaisRow.id,
                                                ParamType.int,
                                              ),
                                            }.withoutNulls,
