...
class CpEstabelecimentoDashboardModel
  ...
  // Stores action output result for [Custom Action - verifyNotificationPermission] action in Button widget.
  bool? resultVerifPermi;
  // Stores action output result for [Custom Action - getOneSignalUserId] action in Button widget.
  String? resultGetIDOneSignalx;
  // Stores action output result for [Action Block - acInicializarNotificacoesOneSignal] action in Button widget.
