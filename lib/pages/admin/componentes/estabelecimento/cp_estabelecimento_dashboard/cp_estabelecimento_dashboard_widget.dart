                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                _model.resultGetIDOneSignalx =
                                    await actions.getOneSignalUserId();
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                                    return WebViewAware(
                            ...
                            Row(
                              ...
                              children: [
                                Flexible(
                                  child: SelectionArea(
                                      child: Text(
                                    'Notificações ativas: ${FFAppState().varNotificacoesAtivas.toString()}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.readexPro(
                            ...
                            Row(
                              ...
                              children: [
                                Flexible(
                                  child: SelectionArea(
                                      child: Text(
                                    'One Signal Inicializado: ${FFAppState().varOneSignalInicializado.toString()}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.readexPro(
                            ...
                            FlutterFlowWebView(
                              content:
                                  'https://fantastic-duckanoo-36caa5.netlify.app/home/${currentUserUid}',
                              bypass: false,
                              width: MediaQuery.sizeOf(context).width * 1.0,
                              height: 300.0,
