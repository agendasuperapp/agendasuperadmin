...
import 'pg_estabelecimento_plano_model.dart';
export 'pg_estabelecimento_plano_model.dart';

class PgEstabelecimentoPlanoWidget extends StatefulWidget {
  const PgEstabelecimentoPlanoWidget({super.key});

  static String routeName = 'pg_estabelecimento_plano';
  static String routePath = '/admin/pgEstabelecimentoPlano';

  @override
  State<PgEstabelecimentoPlanoWidget> createState() =>
      _PgEstabelecimentoPlanoWidgetState();
}

class _PgEstabelecimentoPlanoWidgetState
    extends State<PgEstabelecimentoPlanoWidget> {
  late PgEstabelecimentoPlanoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgEstabelecimentoPlanoModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'ESTABELECIMENTO_PLANO',
              ...
              child: Align(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: wrapWithModel(
                        model: _model.cpEstabelecimentoPlanoModel,
                        updateCallback: () => safeSetState(() {}),
                        child: CpEstabelecimentoPlanoWidget(),
                      ),
                    ),
                  ],
                ),
