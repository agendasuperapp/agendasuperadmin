...
import 'pg_estabelecimentos_admin_model.dart';
export 'pg_estabelecimentos_admin_model.dart';

class PgEstabelecimentosAdminWidget extends StatefulWidget {
  const PgEstabelecimentosAdminWidget({super.key});

  static String routeName = 'pg_estabelecimentos_admin';
  static String routePath = '/admin/Estabelecimentos';

  @override
  State<PgEstabelecimentosAdminWidget> createState() =>
      _PgEstabelecimentosAdminWidgetState();
}

class _PgEstabelecimentosAdminWidgetState
    extends State<PgEstabelecimentosAdminWidget> {
  late PgEstabelecimentosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgEstabelecimentosAdminModel());
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Flexible(
                            child: wrapWithModel(
                              model: _model.cpListaEstabelecimentosAdminModel,
                              updateCallback: () => safeSetState(() {}),
                              child: CpListaEstabelecimentosAdminWidget(),
                            ),
                          ),
                        ],
                      ),
