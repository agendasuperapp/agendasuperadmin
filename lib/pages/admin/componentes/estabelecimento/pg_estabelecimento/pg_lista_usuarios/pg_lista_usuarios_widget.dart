...
import 'pg_lista_usuarios_model.dart';
export 'pg_lista_usuarios_model.dart';

class PgListaUsuariosWidget extends StatefulWidget {
  const PgListaUsuariosWidget({super.key});

  static String routeName = 'pg_lista_usuarios';
  static String routePath = '/padmin/Users';

  @override
  State<PgListaUsuariosWidget> createState() => _PgListaUsuariosWidgetState();
}

class _PgListaUsuariosWidgetState extends State<PgListaUsuariosWidget> {
  late PgListaUsuariosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgListaUsuariosModel());
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CpMenuLateralWidget(
                      paramBotaoSelecionado: 'USUARIOS',
