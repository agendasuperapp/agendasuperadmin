...
import '/pages/b_estabelecimento/comp_estabelecimento/cp_configurar_hr_padrao/cp_configurar_hr_padrao_widget.dart';
                                  ...
                                  children: [
                                                                ...
                                                                if (_model.uploadedFileUrl_uploadDataProfissionais !=
                                                                  ...
                                                                  return _model
                                                                      .uploadedFileUrl_uploadDataProfissionais;
                                                                            ...
                                                                            .paramCadastro ==
                                                                        false) &&
                                                                    (_model.queryTbProfissionais?.firstOrNull?.foto !=
                                                                            null &&
                                                                        _model.queryTbProfissionais?.firstOrNull?.foto !=
                                                                            '')) {
                                                                  return _model
                                                                    ...
                                                                    child: Row(
                                                                      mainAxisSize:
                                                                          MainAxisSize
                                                                              .max,
                                                                      children: [
                                                                        if (_model.varTblProfissionalServLib.where((e) => e.idServico == staggeredViewServLibTblCadServicosRow.id).toList().length >
                                                                            0)
                                                                          Icon(
                                                                    ...
                                                                    child: Row(
                                                                      mainAxisSize:
                                                                          MainAxisSize
                                                                              .max,
                                                                      children: [
                                                                        if (_model.varTblProfissionalServLib.where((e) => e.idServico == listViewTblCadServicosRow.id).toList().length >
                                                                            0)
                                                                          Icon(
                                                                            Icons.check_box_outlined,
                                                                            color:
                                                          ...
                                                          FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              safeSetState(() {
                                                                _model.isDataUploading_uploadDataProfissionais =
                                                                    false;
                                                                _model.uploadedLocalFile_uploadDataProfissionais = FFUploadedFile(
                                                                    bytes: Uint8List
                                                                        .fromList(
                                                                            []),
                                                                    originalFilename:
                                    ...
                                    Align(
                                      ...
                                      child: FutureBuilder<
                                        ...
                                        future:
                                            ViewTblHorariosPadraoCount2Table()
                                                .querySingleRow(
                                          queryFn: (q) => q
                                              .eqOrNull(
                                                'id_estabelecimento',
                                                                ...
                                                                children: List.generate(
                                                                  ...
                                                                  return InkWell(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      decoration:
                                                                          BoxDecoration(
                                                                        color: rowDiasSemSelectViewTblHorariosFuncionamentoRow.fechado!
                                                                            ? Color(0x1AFF5963)
                                                                            : Colors.transparent,
                                                                        borderRadius:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            _model.textFieldHoraPadraoOp2TextController,
                                                                        focusNode:
                                                                            _model.textFieldHoraPadraoOp2FocusNode,
                                                                        onFieldSubmitted:
                                                                            (_) async {
                                                                          _model.varAdicionandoHr =
                                                                              true;
                                                                      ...
                                                                      await showDialog(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Dialog(
                                                                            ...
                                                                            child:
                                                                                WebViewAware(
                                                                              child: CpConfigurarHrPadraoWidget(),
                                                                            ),
                                                                          );
                                                                        },
                                                                      );
                                                                    ...
                                                                    return Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final varHorasPadrao =
                                                                                staggeredViewHrPadraoViewTblHorariosPadraoRow.horasDisponiveis.toList();
                                                                            ...
                                                                            return ListView.separated(
                                                                              ...
                                                                              itemCount: varHorasPadrao.length,
                                                                              separatorBuilder: (_, __) => SizedBox(height: 4.0),
                                                                              itemBuilder: (context, varHorasPadraoIndex) {
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              title: Text('Atenção!'),
                                                                              content: Text('Deseja excluir todos os horários padrões?'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                  child: Text('Não'),
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return ListView
                                                                        ...
                                                                        scrollDirection:
                                                                            Axis.vertical,
                                                                        itemCount:
                                                                            listViewHrFuncionamentoViewTblHorariosFuncionamentoRowList.length,
                                                                        separatorBuilder:
                                                                            (_, __) =>
                                                                                SizedBox(height: 4.0),
                                                                        itemBuilder:
                                                                          ...
                                                                          return Container(
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: FFAppState().VarTblEstabelecimentoLogado.idTema == 1 ? FlutterFlowTheme.of(context).secondaryBackground : Color(0x00000000),
                                                                              borderRadius: BorderRadius.circular(8.0),
                                                                              border: Border.all(
                                                                        ...
                                                                        controller:
                                                                            _model.listViewHrFuncionamentoScrollController,
                                                                      );
                                                                    },
                                                                  ),
                                                                ),
                                                                      ...
                                                                      unawaited(
                                                                        () async {
                                                                          await TblHorariosDisponiveisTable()
                                                                            ...
                                                                            'hora':
                                                                                _model.queryHrsPadroes?.elementAtOrNull(_model.varContadorCdProfissionais)?.hora,
                                                                            'situacao':
                                                                                true,
                                                                            'dia_mes_data':
                                                                                supaSerialize<DateTime>(functions.fcAdicionarDiasEmData(FFAppState().varCalendarioDataSelecionada!, _model.varContadorAddDias)),
                                                                            'user_id':
                                                                                FFAppState().VarTblEstabelecimentoLogado.userId,
                                                                          });
                                                                        }(),
                                                                      );
                                                                      _model.varContadorCdProfissionais =
                                                                      ...
                                                                      if (_model
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              if (varDiasDisponiveisProfissionalItem.situacaoAgendamento == true) {
                                                                                await showDialog(
                                                                                  context: context,
                                                                                  builder: (alertDialogContext) {
                                                                                    return WebViewAware(
