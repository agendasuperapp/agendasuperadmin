...
class CpProfissionaisWidget extends StatefulWidget {
  const CpProfissionaisWidget({
    super.key,
    bool? paramAdmin,
  ...
  @override
  State<CpProfissionaisWidget> createState() => _CpProfissionaisWidgetState();
}

class _CpProfissionaisWidgetState extends State<CpProfissionaisWidget>
    with TickerProviderStateMixin {
  late CpProfissionaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpProfissionaisModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: FutureBuilder<List<ViewQuantTblProfissionaisRow>>(
          future: ViewQuantTblProfissionaisTable().querySingleRow(
            queryFn: (q) => q
                .eqOrNull(
                  'id_estabelecimento',
          ...
          builder: (context, snapshot) {
            ...
            List<ViewQuantTblProfissionaisRow>
                stackViewQuantTblProfissionaisRowList = snapshot.data!;

            final stackViewQuantTblProfissionaisRow =
                stackViewQuantTblProfissionaisRowList.isNotEmpty
                    ? stackViewQuantTblProfissionaisRowList.first
                    : null;
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Text(
                                                    widget.paramAdmin
                                                        ? 'Profissionais ${FFAppState().VarTblEstabelecimentoLogado.nomeEstabelecimento}'
                                                        : 'Profissionais',
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'Cadastre os profissionais que fazem serviços no seu estabelecimento',
                                                style:
                        ...
                        FutureBuilder<List<TblProfissionaisRow>>(
                          future: (_model.requestCompleter ??= Completer<
                                  List<TblProfissionaisRow>>()
                                ..complete(TblProfissionaisTable().queryRows(
                                  queryFn: (q) => q
                                      .eqOrNull(
                                        'id_estabelecimento',
                                        FFAppState().VarIDEstabelecimentoLogado,
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<TblProfissionaisRow>
                                listViewTblProfissionaisRowList =
                                snapshot.data!;

                            if (listViewTblProfissionaisRowList.isEmpty) {
                            ...
                            return ListView.separated(
                              ...
                              itemCount: listViewTblProfissionaisRowList.length,
                              separatorBuilder: (_, __) =>
                                  SizedBox(height: 8.0),
                              itemBuilder: (context, listViewIndex) {
                                final listViewTblProfissionaisRow =
                                    listViewTblProfissionaisRowList[
                                        listViewIndex];
                                return Container(
                                  decoration: BoxDecoration(
                                    color: listViewTblProfissionaisRow.situacao!
                                        ? FlutterFlowTheme.of(context)
                                                ...
                                                builder: (context) => Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    highlightColor:
                                                        Colors.transparent,
                                                    onTap: () async {
                                                      if (listViewTblProfissionaisRow
                                                                  .foto !=
                                                              null &&
                                                          listViewTblProfissionaisRow
                                                                  .foto !=
                        ...
                        if (_model.varSituacaoCadastro &&
                            (stackViewQuantTblProfissionaisRow?.quant !=
                                null) &&
                            (stackViewQuantTblProfissionaisRow!.quant! >
                                FFAppState()
                        ...
                        if (stackViewQuantTblProfissionaisRow?.quant != null)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 0.0),
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsets.all(8.0),
                                    child: Text(
                                      'Profissionais: ${valueOrDefault<String>(
                                        stackViewQuantTblProfissionaisRow?.quant
                                            ?.toString(),
                                        '0',
                                      )} de ${FFAppState().VarTblEstabelecimentoLogado.quantProfissionaisMax.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.readexPro(
                    ...
                    builder: (context) => Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.queryQtProfissionaisCad =
                              await ViewQuantTblProfissionaisTable().queryRows(
                            queryFn: (q) => q
                                .eqOrNull(
                                  'id_estabelecimento',
                                  FFAppState().VarIDEstabelecimentoLogado,
                          ...
                          if ((_model.queryQtProfissionaisCad!.length > 0) &&
                              (_model.queryQtProfissionaisCad!.firstOrNull!
                                      .quant! >=
                                  FFAppState()
                                      .VarTblEstabelecimentoLogado
                                      .quantProfissionaisMax)) {
                          ...
                          if (FFAppState().VarAbrirJanelasWebAndroid) {
                            context.pushNamed(
                              PgCadProfissionaisWidget.routeName,
                              queryParameters: {
