...
import 'pg_agendamentos_diarios_model.dart';
export 'pg_agendamentos_diarios_model.dart';

class PgAgendamentosDiariosWidget extends StatefulWidget {
  const PgAgendamentosDiariosWidget({super.key});

  static String routeName = 'pg_agendamentosDiarios';
  static String routePath = '/admin/AgDiarios';

  @override
  State<PgAgendamentosDiariosWidget> createState() =>
      _PgAgendamentosDiariosWidgetState();
}

class _PgAgendamentosDiariosWidgetState
    extends State<PgAgendamentosDiariosWidget> {
  late PgAgendamentosDiariosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAgendamentosDiariosModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'AGENDAMENTOSDIARIOS',
