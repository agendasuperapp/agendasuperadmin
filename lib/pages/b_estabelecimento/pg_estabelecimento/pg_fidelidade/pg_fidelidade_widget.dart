...
import 'pg_fidelidade_model.dart';
export 'pg_fidelidade_model.dart';

class PgFidelidadeWidget extends StatefulWidget {
  const PgFidelidadeWidget({super.key});

  static String routeName = 'pg_fidelidade';
  static String routePath = '/admin/Fidelidade';

  @override
  State<PgFidelidadeWidget> createState() => _PgFidelidadeWidgetState();
}

class _PgFidelidadeWidgetState extends State<PgFidelidadeWidget> {
  late PgFidelidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgFidelidadeModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'FIDELIDADE',
                          paramGrupoBotao: 'FIDELIDADE',
