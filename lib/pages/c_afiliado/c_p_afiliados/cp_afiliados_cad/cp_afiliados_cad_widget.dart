...
import '/pages/a_home/cp_home/cp_foto/cp_foto_widget.dart';
import '/pages/b_estabelecimento/comp_estabelecimento/cp_validar_email_tel/cp_validar_email_tel_widget.dart';
import '/pages/c_afiliado/c_p_afiliados/cp_afiliado_aviso_cadastro/cp_afiliado_aviso_cadastro_widget.dart';
import '/pages/c_afiliado/c_p_afiliados/cp_nota_fiscal/cp_nota_fiscal_widget.dart';
import '/pages/e_sistema/page_mensagens_personalizadas/cp_dialog_snack_bar/cp_dialog_snack_bar_widget.dart';
import 'dart:async';
...
class CpAfiliadosCadWidget extends StatefulWidget {
  const CpAfiliadosCadWidget({
    super.key,
    bool? paramAdmin,
    required this.paramInscricao,
  }) : this.paramAdmin = paramAdmin ?? false;

  final bool paramAdmin;
  final bool? paramInscricao;

  @override
  State<CpAfiliadosCadWidget> createState() => _CpAfiliadosCadWidgetState();
}

class _CpAfiliadosCadWidgetState extends State<CpAfiliadosCadWidget>
    with TickerProviderStateMixin {
  late CpAfiliadosCadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpAfiliadosCadModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (FFAppState().varCarregouPrimeiraPagina && !widget.paramInscricao!) {
        context.pushNamed(PgAfiliadoCpfWidget.routeName);
      ...
      if ((FFAppState().varTblAfiliado.statusAfiliacao == 'EMISSAONF') &&
          !FFAppState().varTblAfiliado.nfEmitida) {
        await showDialog(
          context: context,
    ...
    _model.textFieldNomeAfiliadoTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.nome);
    _model.textFieldNomeAfiliadoFocusNode ??= FocusNode();

    _model.textFieldIDAfiliadoTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.id.toString());
    _model.textFieldIDAfiliadoFocusNode ??= FocusNode();

    _model.textFieldUsernameTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.username);
    _model.textFieldUsernameFocusNode ??= FocusNode();

    _model.textFieldTelTextController ??= TextEditingController(
        text: FFAppState().varTblAfiliado.telefone != ''
            ? FFAppState().varTblAfiliado.telefone
            : FFAppState().VarTblEstabelecimentoLogado.telefoneEstabelecimento);
    ...
    _model.textFieldCPFTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.docCpfCnpj);
    _model.textFieldCPFFocusNode ??= FocusNode();

    _model.textFieldCPFMask = MaskTextInputFormatter(mask: '###.###.###-##');
    _model.textFieldCNPJTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.docCpfCnpj);
    _model.textFieldCNPJFocusNode ??= FocusNode();

    _model.textFieldCNPJMask =
        MaskTextInputFormatter(mask: '##.###.###.####-##');
    _model.textFieldCEPTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.cep);
    ...
    _model.textFieldRuaTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.rua);
    _model.textFieldRuaFocusNode ??= FocusNode();

    _model.textFieldNumeroTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.numero);
    _model.textFieldNumeroFocusNode ??= FocusNode();

    _model.textFieldComplementoTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.complemento);
    _model.textFieldComplementoFocusNode ??= FocusNode();

    _model.textFieldCidadeTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.cidade);
    _model.textFieldCidadeFocusNode ??= FocusNode();

    _model.textFieldBairroTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.bairro);
    _model.textFieldBairroFocusNode ??= FocusNode();

    _model.textFieldEstadoTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.uf);
    _model.textFieldEstadoFocusNode ??= FocusNode();

    _model.textFieldInstagramTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.instagran);
    _model.textFieldInstagramFocusNode ??= FocusNode();

    _model.textFieldFacebookTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.facebook);
    _model.textFieldFacebookFocusNode ??= FocusNode();

    _model.textFielTikTokTextController ??=
        TextEditingController(text: FFAppState().varTblAfiliado.tiktok);
    _model.textFielTikTokFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      constraints: BoxConstraints(
        minHeight: widget.paramInscricao! &&
                (MediaQuery.sizeOf(context).width < 1000.0)
            ? MediaQuery.sizeOf(context).height
            : 10.0,
        maxWidth: () {
          if (!widget.paramInscricao!) {
        ...
        children: [
          Padding(
            ...
            child: SingleChildScrollView(
              controller: _model.columnAfiliadoScrollController,
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            FFAppState().VarTblEstabelecimentoLogado.idTema == 1
                                ? FlutterFlowTheme.of(context)
                                    ...
                                    child: Builder(
                                      builder: (context) => Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            if ((_model.uploadedFileUrl_uploadDataAfliliadoPerfil !=
                                                        '') ||
                                                (FFAppState()
                                                            .varTblAfiliado
                                                            .fotoPerfil !=
                                            ...
                                            child: Image.network(
                                              valueOrDefault<String>(
                                                FFAppState()
                                                    .varTblAfiliado
                                                    .fotoPerfil,
                                                'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/agendador-de-beleza-qia8mb/assets/rrbhj5689n2g/2a2e7f0f60b750dfb36c15c268d0118d.jpg',
                                              ),
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              safeSetState(() {
                                                _model.isDataUploading_uploadDataAfliliadoPerfil =
                                                    false;
                                                _model.uploadedLocalFile_uploadDataAfliliadoPerfil =
                                                    FFUploadedFile(
                                                        bytes:
                                                            Uint8List.fromList(
                                                                []),
                                              ...
                                              if (selectedMedia != null &&
                                                  selectedMedia.every((m) =>
                                                      validateFileFormat(
                                                          ...
                                                          context))) {
                                                safeSetState(() => _model
                                                        .isDataUploading_uploadDataAfliliadoPerfil =
                                                    true);
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: FFAppState().VarTblEstabelecimentoLogado.idTema ==
                              1
                        ...
                        children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            if (kDebugMode ||
                                              ...
                                              safeSetState(() {
                                                _model.textFieldTelTextController
                                                        ?.text =
                                                    '(00) 00000-${random_data.randomString(
                                                  4,
                                                  4,
                                                  false,
                                                  false,
                                  ...
                                  children: [
                                    Flexible(
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model
                                              .textFieldNomeAfiliadoFocusNode,
                                          onChanged: (_) =>
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .textFieldIDAfiliadoTextController,
                                          focusNode: _model
                                              .textFieldIDAfiliadoFocusNode,
                                          autofocus: false,
                                          autofillHints: [AutofillHints.name],
                                          textCapitalization:
                                              TextCapitalization.words,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              readOnly: (FFAppState()
                                                              ...
                                                              .username !=
                                                          '') &&
                                                  !_model.varEditarUsername,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                isDense: true,
                                                labelText:
                                                    'Username (Para compartilhar seu link)',
                                                labelStyle: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                                                    .override(
                                      ...
                                      if ((_model.varEditarUsername &&
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            _model.varEditarUsername = false;
                                            safeSetState(() {});
                                          },
                                          text:
                                              MediaQuery.sizeOf(context).width <
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            'ATENÇÃO! Escolha o novo Username e salve, você deverá liberar novos cupons novamente.  O username antigo ${FFAppState().varTblAfiliado.username} ficará disponível para qualquer pessoa cadastrar novamente. ',
                                  ...
                                  children: [
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .textFieldTelTextController,
                                                      focusNode: _model
                                                          .textFieldTelFocusNode,
                                                      autofocus: false,
                                                      autofillHints: [
                                                        AutofillHints
                                                      ...
                                                      decoration:
                                                        ...
                                                        isDense: true,
                                                        labelText:
                                                            'Telefone WhatsApp  Código País + (DDD) + Telefone',
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                                      ...
                                                      cursorColor:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .primaryText,
                                                      validator: _model
                                                          .textFieldTelTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode: _model
                                            .textFieldDtNascimentoFocusNode,
                                        autofocus: false,
                                        textInputAction: TextInputAction.next,
                                        readOnly: true,
                                        obscureText: false,
                                        ...
                                        if (_model.dropDownTipoDocValue ==
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .textFieldCNPJTextController,
                                                focusNode: _model
                                                    .textFieldCNPJFocusNode,
                                                autofocus: false,
                                                textInputAction:
                                                    TextInputAction.next,
                                                readOnly: true,
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                                validator: _model
                                                    .textFieldCNPJTextControllerValidator
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  _model.textFieldCNPJMask
                                                ],
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (_) => EasyDebounce.debounce(
                                        ...
                                        () async {
                                          ...
                                          if (_model.textFieldCEPTextController
                                                      .text ==
                                                  '') {
                          ...
                          if (responsiveVisibility(
                            ...
                            Row(
                              ...
                              children: [
                                Flexible(
                                  child: FutureBuilder<List<ViewTblEstadosRow>>(
                          ...
                          Container(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.textFieldEstadoTextController,
                                focusNode: _model.textFieldEstadoFocusNode,
                                autofocus: false,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 4.0, 8.0, 4.0),
                                child: Text(
                                  'ATENÇÃO! Preencha os dados acima corretamente pois serão usados para emitir Nota Fisca Eletrônica.',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                              ...
                                              Flexible(
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .textFielTikTokTextController,
                                                      focusNode: _model
                                                          .textFielTikTokFocusNode,
                                                      onChanged: (_) =>
                                                          EasyDebounce.debounce(
                                                        '_model.textFielTikTokTextController',
                                                        Duration(
                      ...
                      child: Builder(
                        builder: (context) => Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((_model.textFieldCEPTextController.text ==
                                  ...
                                  (_model.textFieldBairroTextController
                                              .text ==
                                          '')) {
                                await _model.columnAfiliadoScrollController
                                    ?.animateTo(
                                  _model.columnAfiliadoScrollController!
                                      .position.maxScrollExtent,
                                  duration: Duration(milliseconds: 100),
                                  curve: Curves.ease,
                                );
                              }
                              if ((_model.textFieldUsernameTextController
                                              .text ==
                                          '') ||
                              ...
                              if (_model.textFieldNomeAfiliadoTextController
                                          .text ==
                                      '') {
                                await showDialog(
                                  context: context,
                              ...
                              if (_model.textFieldUsernameTextController.text ==
                                      '') {
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                              ...
                              if (functions.fcCountCaracteres(_model
                                      .textFieldUsernameTextController.text) <
                                  5) {
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                              ...
                              _model.acResultConsUsername =
                                  await action_blocks.acConsultarUsername(
                                context,
                                paramUsername:
                              ...
                              _shouldSetState = true;
                              if (_model.acResultConsUsername != 'False') {
                                if (_shouldSetState) safeSetState(() {});
                                return;
                              }
                              _model.acResultConsCupom =
                              ...
                              _shouldSetState = true;
                              if (_model.acResultConsCupom != 'False') {
                                if (_shouldSetState) safeSetState(() {});
                                return;
                              }
                              if (_model.textFieldTelTextController.text ==
                                      '') {
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                              ...
                              _model.resultConsTelefone =
                                  await action_blocks.acConsultarTelefone(
                                context,
                                paramTelefone:
                                    _model.textFieldTelTextController.text,
                                paramTabela: 'tbl_afiliados',
                                paramID: FFAppState().varIDAfiliadoLogado,
                              );
                              _shouldSetState = true;
                              if (_model.resultConsTelefone != 'False') {
                                if (_shouldSetState) safeSetState(() {});
                                return;
                              }
                              ...
                              if ((functions.fcCopararAnosDuasDatas(
                                          ...
                                          getCurrentTimestamp) >
                                      120) ||
                                  (functions.fcCopararAnosDuasDatas(
                                          functions.fcConverterStringPData2(_model
                                              .textFieldDtNascimentoTextController
                                              .text)!,
                                          getCurrentTimestamp) <
                              ...
                              if (_model.dropDownTipoDocValue == null ||
                                  _model.dropDownTipoDocValue == '') {
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                              ...
                              if ((_model.dropDownTipoDocValue == 'CPF') &&
                              ...
                              _model.queryConsAfiliado =
                                  await TblAfiliadosTable().queryRows(
                              ...
                              _shouldSetState = true;
                              if (_model.queryConsAfiliado!.length > 0) {
                                await TblAfiliadosTable().update(
                                  data: {
                                    ...
                                    'numero': _model
                                        .textFieldNumeroTextController.text,
                                    'complemento': _model
                                        .textFieldComplementoTextController
                                        .text,
                                    'bairro': _model
                                        .textFieldBairroTextController.text,
                                    'cidade': _model
                                        .textFieldCidadeTextController.text,
                                    'cep':
                                    ...
                                    'uf': ViaCepCall.uf(
                                        ...
                                        : FFAppState().varTblAfiliado.uf,
                                    'situacao': true,
                                    'telefone':
                                        _model.textFieldTelTextController.text,
                                    'username': functions
                                        .fcConverterStringMinusculo(_model
                                            .textFieldUsernameTextController
                                            .text),
                                    'foto_perfil': _model.uploadedFileUrl_uploadDataAfliliadoPerfil !=
                                                ''
                                        ? _model
                                            .uploadedFileUrl_uploadDataAfliliadoPerfil
                                        : FFAppState()
                                    ...
                                    'tiktok': _model
                                        .textFielTikTokTextController.text,
                                    'instagran': _model
                                        .textFieldInstagramTextController.text,
                                    'tipo_doc': _model.dropDownTipoDocValue,
                                    'doc_cpf_cnpj':
                                        _model.dropDownTipoDocValue == 'CPF'
                                            ? _model
                              ...
                              if (FFAppState().varTblAfiliado.statusAfiliacao ==
                                ...
                                if (!FFAppState().varTblAfiliado.nfEmitida) {
                                  await showDialog(
                                ...
                                context.pushNamed(
                                    PgAfiliadoTreinamentoWidget.routeName);
                              } else {
                            ...
                            text: FFAppState().varTblAfiliado.nfEmitida
                                ? 'Salvar'
                                : 'Salvar e Emitir NF',
                            icon: Icon(
                              Icons.check,
                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed(PgResetSenhaWidget.routeName);
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                          ...
                          if (responsiveVisibility(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  PgExclusaoContaWidget.routeName,
                                  extra: <String, dynamic>{
                                    kTransitionInfoKey: TransitionInfo(
                                      hasTransition: true,
                                      transitionType: PageTransitionType.fade,
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              Function() _navigate = () {};
                              _model.acSairSistemaResultAfili =
                                  await action_blocks.acSairSistema(
                                context,
                                paramPerguntar: true,
                              );
                              if (_model.acSairSistemaResultAfili!) {
