...
import '/pages/c_afiliado/c_p_afiliados/cp_afiliado_indicacoes/cp_afiliado_indicacoes_widget.dart';
...
class PgAfiliadoIndicacoesWidget extends StatefulWidget {
  const PgAfiliadoIndicacoesWidget({super.key});

  static String routeName = 'pg_afiliado_indicacoes';
  static String routePath = '/admin/AfiliadoIndicacoes';

  @override
  State<PgAfiliadoIndicacoesWidget> createState() =>
      _PgAfiliadoIndicacoesWidgetState();
}

class _PgAfiliadoIndicacoesWidgetState
    extends State<PgAfiliadoIndicacoesWidget> {
  late PgAfiliadoIndicacoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgAfiliadoIndicacoesModel());
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: wrapWithModel(
                          model: _model.cpAfiliadoIndicacoesModel,
                          updateCallback: () => safeSetState(() {}),
                          child: CpAfiliadoIndicacoesWidget(),
                        ),
                      ),
                    ),
                  ],
