...
import '/pages/d_admin/cp_admin/cp_admin_pag_saques_comprovante/cp_admin_pag_saques_comprovante_widget.dart';
                        ...
                        FutureBuilder<List<ViewTblAfiliadoPgSaquesRow>>(
                          future: (_model.requestCompleter ??=
                                  Completer<List<ViewTblAfiliadoPgSaquesRow>>()
                                    ..complete(ViewTblAfiliadoPgSaquesTable()
                                        .queryRows(
                                      queryFn: (q) => q,
                                    )))
                              .future,
                          builder: (context, snapshot) {
                            ...
                            if (listViewViewTblAfiliadoPgSaquesRowList
                                .isEmpty) {
