                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                              .isDataUploading_uploadDataModeloFoto =
                                          true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_uploadDataModeloFoto =
                                            false;
                                      }
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      valueOrDefault<String>(
                                        () {
                                          if (_model.uploadedFileUrl_uploadDataModeloFoto !=
                                                  '') {
                                            return _model
                              ...
                              if (widget.paramCadastro!) {
                                ...
                                await TblModelosFotosTable().update(
                                  data: {
                                    ...
                                    'id_segmento':
                                        _model.varIDSegmentosLiberados,
                                    'foto': _model.uploadedFileUrl_uploadDataModeloFoto !=
                                                ''
                                        ? _model
                                            .uploadedFileUrl_uploadDataModeloFoto
