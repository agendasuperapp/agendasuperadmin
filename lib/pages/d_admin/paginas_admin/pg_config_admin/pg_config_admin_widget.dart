...
import '/pages/d_admin/cp_admin/cp_admin_configuracoes/cp_admin_configuracoes_widget.dart';
import '/actions/actions.dart' as action_blocks;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:provider/provider.dart';
import 'pg_config_admin_model.dart';
export 'pg_config_admin_model.dart';

class PgConfigAdminWidget extends StatefulWidget {
  const PgConfigAdminWidget({super.key});

  static String routeName = 'pg_config_admin';
  static String routePath = '/admin/ConfigAdmin';

  @override
  State<PgConfigAdminWidget> createState() => _PgConfigAdminWidgetState();
}

class _PgConfigAdminWidgetState extends State<PgConfigAdminWidget> {
  late PgConfigAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgConfigAdminModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'CONFIGADMIN',
