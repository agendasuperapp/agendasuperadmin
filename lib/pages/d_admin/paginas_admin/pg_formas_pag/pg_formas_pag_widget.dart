...
import 'pg_formas_pag_model.dart';
export 'pg_formas_pag_model.dart';

class PgFormasPagWidget extends StatefulWidget {
  const PgFormasPagWidget({super.key});

  static String routeName = 'pg_formas_pag';
  static String routePath = '/admin/FormasPag';

  @override
  State<PgFormasPagWidget> createState() => _PgFormasPagWidgetState();
}

class _PgFormasPagWidgetState extends State<PgFormasPagWidget> {
  late PgFormasPagModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgFormasPagModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'FORMASPAG',
