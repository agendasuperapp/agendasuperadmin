...
import 'pg_logs_erros_model.dart';
export 'pg_logs_erros_model.dart';

class PgLogsErrosWidget extends StatefulWidget {
  const PgLogsErrosWidget({super.key});

  static String routeName = 'pg_logs_erros';
  static String routePath = '/admin/LogsErros';

  @override
  State<PgLogsErrosWidget> createState() => _PgLogsErrosWidgetState();
}

class _PgLogsErrosWidgetState extends State<PgLogsErrosWidget> {
  late PgLogsErrosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgLogsErrosModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'LOGSERROS',
