...
import '/pages/d_admin/cp_admin/cp_lista_modelos_fotos/cp_lista_modelos_fotos_widget.dart';
import '/actions/actions.dart' as action_blocks;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:provider/provider.dart';
import 'pg_modelos_fotos_model.dart';
export 'pg_modelos_fotos_model.dart';

class PgModelosFotosWidget extends StatefulWidget {
  const PgModelosFotosWidget({super.key});

  static String routeName = 'pg_modelos_fotos';
  static String routePath = '/admin/ModFotos';

  @override
  State<PgModelosFotosWidget> createState() => _PgModelosFotosWidgetState();
}

class _PgModelosFotosWidgetState extends State<PgModelosFotosWidget> {
  late PgModelosFotosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgModelosFotosModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'MODELOSFOTOS',
