...
import 'pg_relatorios_model.dart';
export 'pg_relatorios_model.dart';

class PgRelatoriosWidget extends StatefulWidget {
  const PgRelatoriosWidget({super.key});

  static String routeName = 'pg_relatorios';
  static String routePath = '/admin/Relatorios';

  @override
  State<PgRelatoriosWidget> createState() => _PgRelatoriosWidgetState();
}

class _PgRelatoriosWidgetState extends State<PgRelatoriosWidget> {
  late PgRelatoriosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgRelatoriosModel());
                    ...
                    if ((MediaQuery.sizeOf(context).width >
                      ...
                      wrapWithModel(
                        ...
                        child: CpMenuLateralWidget(
                          paramBotaoSelecionado: 'RELATORIOS',
